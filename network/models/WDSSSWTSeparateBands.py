...
class WDSSSWTSeparateBands(ModelBase):
    def __init__(self):
        super(WDSSSWTSeparateBands, self).__init__()
    ...
    def forward(self, lr_frame, hr_gbuffer, temporal, upscale_factor):
        ...
        # Combine features
        wavelet_out = torch.cat([fusion_feat, inr_out], dim=1)

        # Pixel shuffle to get back to original resolution
